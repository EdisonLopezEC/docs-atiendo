...
<Callout type="info" >
    Se muestra el cuadre de las fomas de pago que acepta la empresa. Y el valo total de las ventas realizadas en la fecha seleccionada.
</Callout>
...
![Seleccionar caja y fecha](../../assets/images/cuadredetalle.png)
