...
Este módulo le permite crear, editar y eliminar descuentos. Se pueden crear descuentos por porcentaje o por monto fijo. Además, se pueden aplicar descuentos a productos mediante el uso de un código de descuento.
